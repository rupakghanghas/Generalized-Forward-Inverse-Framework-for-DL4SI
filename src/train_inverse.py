...
from networks import forward_network, inverse_network, iunet_network, unet
...
def main(args):
    ...
    if args.model not in inverse_network.model_dict:
    ...
    model = inverse_network.model_dict[args.model](**inverse_model_params[args.model]).to(device)
