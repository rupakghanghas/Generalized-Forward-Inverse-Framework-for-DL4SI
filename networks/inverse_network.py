...
from networks.iunet_network import IUnetInverseModel, UNetInverseModel, IUnetInverseModel_Legacy, UNetInverseModel_Legacy
...
################################################################
# Discriminator for Velocity GAN
################################################################
...
model_dict = {
    ...
    'IUnetInverseModel_Legacy':IUnetInverseModel_Legacy,
    'Discriminator': Discriminator,
    'UNetInverseModel':UNetInverseModel,
    'UNetInverseModel_Legacy':UNetInverseModel_Legacy,
}
